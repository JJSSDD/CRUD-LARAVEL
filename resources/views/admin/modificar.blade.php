...
<html lang="en">
  ...
  <body>
    ...
    <div class="text-center">
        ...
        <form method="post" action="{{ route('equipo.editar') }}">
            @csrf
            <label class="font-weight-bold" for="nombre">Nombre</label>
            <input type="text" name="nombre" id="nombre" value="{{$equipo->nombre}}">

            <label class="font-weight-bold" for="region">Region</label>
            <input type="text" name="region" id="region" value="{{$equipo->region}}">

            <label class="font-weight-bold" for="n_integrantes">n_integrantes</label>
            <input type="text" name="n_integrantes" id="n_integrantes" value="{{$equipo->n_integrantes}}"><br>

            <label class="font-weight-bold" for="f_creacion">f_creacion</label>
            <input type="date" name="f_creacion" id="f_creacion" value="{{$equipo->f_creacion}}"><br>

            <button type="submit" class="btn btn-outline-primary m-3 font-weight-bold">Editar</button>
        </form>
    </div>
